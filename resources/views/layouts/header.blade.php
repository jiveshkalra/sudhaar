...
<body>
    ...
    @endif
    <!-- Register -->
    <div id="registeration-modal" tabindex="-1" aria-hidden="true"
    ...
    <div id="user-pass-modal" tabindex="-1" aria-hidden="true"
        class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-md max-h-full">
            <!-- Modal content -->
            <div class="relative rounded-lg model">
                ...
                <div class="px-6 py-6 lg:px-8">
                    @if (Session::has('username') && Session::has('password'))
                        <h3 class="mb-4 text-xl font-medium">Your Username And Password is</h3>
                        <div class="p-6 space-y-6">
                            ...
                            <p class="text-sm leading-relaxed text-red-600">
                                <strong>These credentials have to be stored somewhere</strong> and a copy has been sent
                                to your email address for your records.
                            </p>
                        </div>
                    @else
                        <h3 class="mb-4 text-xl font-medium text-red-600">ERROR!</h3>
                        <div class="p-6 space-y-6">
                            <p class="text-sm leading-relaxed text-red-600">
